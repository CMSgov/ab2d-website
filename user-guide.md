...
Both environments use the same endpoints with the main differences being the credentials used for your [bearer token]({{ '/get-a-bearer-token' | relative_url }}) and the environment URL. 
